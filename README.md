...
- **Grupo**: O trabalho será realizado em grupos de até 5 alunos, com cada membro assumindo uma função específica dentro do grupo.
- **Pontuação**: A avaliação vale 3 pontos, que serão somados à nota da Avaliação 2 da disciplina de Programação Orientada a Objetos e Estruturas de Dados.
- **Apresentação**: O grupo deverá apresentar o trabalho em sala de aula na data definida pelo docente.
- **Participação**: Todos os membros do grupo devem participar ativamente das etapas do trabalho. A colaboração integral será um critério importante na avaliação.
...
- **Busca**: Buscar elementos na lista.
